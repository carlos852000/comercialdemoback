...
public class VerificarProductoxIdResponse {
	...
	private Integer unidadmedidacantidad;
	...
	private Integer indicadorRedondeoPrecio;
	...
	public Integer getUnidadmedidacantidad() {
		return unidadmedidacantidad;
	}
	public void setUnidadmedidacantidad(Integer unidadmedidacantidad) {
	...
	public Integer getIndicadorRedondeoPrecio() {
		return indicadorRedondeoPrecio;
	}
	public void setIndicadorRedondeoPrecio(Integer indicadorRedondeoPrecio) {
		this.indicadorRedondeoPrecio = indicadorRedondeoPrecio;
	}
